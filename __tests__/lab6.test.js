...
describe('Basic user flow for Website', () => {
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    const button = await productItem.evaluateHandle((node) => node.shadowRoot.querySelector('button'));
    await button.click();
    const buttonText = await productItem.evaluate((node) => node.shadowRoot.querySelector('button').innerText);
  ...
  it('Checking number of items in cart on screen', async () => {
    ...
    // unclick button from pervious test
    const productItem = await page.$('product-item');
    const button = await productItem.evaluateHandle((node) => node.shadowRoot.querySelector('button'));
    await button.click();
